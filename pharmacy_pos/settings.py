...
SECRET_KEY = 'django-insecure-029u0k%@0*%fafq4u_l-i@5(&cp5)o1ro23^x&c@nshrd0sr#4'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Bienvenue sur la Pharmacie de la Poste",

    # Copyright on the footer
    "copyright": "Pharmacie de la Poste",
    ...
    "order_with_respect_to": ["sales", "catalog", "auth", "accounts"],
